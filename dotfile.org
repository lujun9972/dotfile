...
#+BEGIN_SRC lua :tangle "~/.config/awesome/rc.lua"
  function customization.func.take_client_screen(c,path)
    c = c or awful.menu.clients({ theme = { width = 250 } })
...
#+BEGIN_SRC lua :tangle "~/.config/awesome/rc.lua"
  globalkeys = gears.table.join(
    ...
    -- 保存client屏幕
    awful.key({ modkey, "Shift"}, "p", customization.func.take_client_screen,
...
#+BEGIN_SRC  lua :tangle "~/.config/awesome/rc.lua"
  clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Ctrl"}, "p", customization.func.take_client_screen,
