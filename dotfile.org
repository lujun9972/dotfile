...
#+BEGIN_SRC  lua :tangle "~/.config/awesome/rc.lua"
  ...
  my_holiday_watcher,my_holiday_timer = awful.widget.watch([[emacsclient -e '
...
#+BEGIN_SRC  lua :tangle "~/.config/awesome/rc.lua"
  ...
  my_emms_watcher,my_emms_timer = awful.widget.watch([[emacsclient -e '(when emms-player-playing-p
